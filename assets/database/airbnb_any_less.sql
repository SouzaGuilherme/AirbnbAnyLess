...
(12, 4306601, 'RS', 'logradouro', 123, 'complemento', 'bairro', '96450000'),
(13, 4306601, 'RS', 'Moreira Cesar', 671, 'Apto 1', 'Centro', '96450000'),
(14, 1200013, 'AC', ' Logradouro', 123, 'Complemento ', 'Bairro ', 'CEP '),
(15, 1200013, 'AC', ' Logradouro', 111111, 'Complemento ', 'Bairro ', 'CEP '),
(16, 4300034, 'RS', 'Logradouro X', 444, 'Complemento X', 'Centro X', '90000'),
(17, 4300034, 'RS', 'Moreira Cesar', 671, 'Centro', 'Centro', '96450000'),
(18, 4300034, 'RS', 'Logradouro RS ', 123, 'Complemento RS ', 'Bairro RS ', '9645000 '),
(19, 4300034, 'RS', 'Logradouro RS ', 123, 'Complemento RS ', 'Bairro RS ', '9645000 '),
(20, 4300034, 'RS', 'Logradouro RS ', 123, 'Complemento RS ', 'Bairro RS ', '9645000 '),
(21, 4300034, 'RS', 'Logradouro RS ', 123, 'Complemento RS ', 'Bairro RS ', '9645000 '),
(22, 4300034, 'RS', 'Logradouro RS ', 44, 'Complemento RS ', 'Bairro RS ', '9645000 '),
(23, 4300034, 'RS', 'Logradouro RS ', 44, 'Complemento RS ', 'Bairro RS ', '9645000 '),
(24, 4300034, 'RS', 'Logradouro 1', 12, 'Complemento 1  ', 'Bairro 1 ', '9645000 '),
(25, 3300100, 'RJ', 'Logradouro Locatario', 1111, 'Complemento Locatario', 'Bairro Locatario', '111111'),
(26, 1200013, 'AC', 'Logradouro Locatario', 1111, 'Complemento Locatario', 'Bairro Locatario', '111111'),
(27, 2706109, 'AL', 'Logradouro', 22222, 'Complemento Proprietario', 'Bairro Proprietario', '222222'),
(28, 4127809, 'PR', 'Logradouro Proprietario', 2222, 'Complemento Proprietario', 'Bairro Proprietario', '22222'),
(29, 2900306, 'BA', 'Logradouro Ambos', 33333, 'Complemento Ambos', 'Bairro Ambos', '33333'),
(30, 2900306, 'BA', 'Logradouro Ambos', 33333, 'Complemento Ambos', 'Bairro Ambos', '33333'),
(31, 1200013, 'AC', ' Logradouro 1', 111, ' Complemento 1', 'Bairro 1 ', '11111 '),
(32, 1200203, 'AC', ' Logradouro 2', 222, 'Complemento 2 ', 'Bairro 2 ', '22222 '),
(33, 1200013, 'AC', ' 12312312', 3123, ' 312312', ' 123123', ' 312'),
(34, 1200013, 'AC', '11111111111111111111111', 111111, '111111111', '1111111111111111111111111111111111', '123123121'),
(35, 1200013, 'AC', '11111111111111111111111', 111111, '111111111', '1111111111111111111111111111111111', '123123121'),
(36, 4300034, 'RS', 'Moreira Cesar', 671, 'Apto 1', 'Centro', '96450000'),
(37, 1200013, 'AC', 'Logradouro X ', 459, 'Complemento X ', 'Bairro X ', '96010770 '),
(38, 1200013, 'AC', ' Logradouro', 459, 'Complemento ', 'Bairro ', '96450000 '),
(39, 1200013, 'AC', ' Logradouro', 459, 'Complemento ', 'Bairro ', '96450000 '),
(40, 4123501, 'PR', ' Logradouro', 123213, ' Complemento', 'Bairro ', '96423432 '),
(41, 1200013, 'AC', 'Logradouro', 113232, 'LogradouroLogradouroLogradouro', 'LogradouroLogradouro', '111111111'),
(42, 1200013, 'AC', ' logradouro logradouro', 111111, ' complementocomplemento complemento', 'bairro bairro ', '123123121'),
(43, 1200013, 'AC', 'Logradouro Locatario', 123123, 'aasdasdasd', 'Bairro Centro', '123123123'),
(44, 2900108, 'BA', 'Logradouro do Proprietario', 129301, 'Complemento do Proprietario', 'Bairo do do Proprietario', '091283901'),
(45, 4306601, 'RS', 'Logradouro Guilherme', 123456, 'Complemento Guilherme', 'Centro', '96450000'),
(46, 4306601, 'RS', 'Logradouro Guilherme', 123456, 'Complemento Guilherme', 'Centro', '96450000'),
(47, 1200500, 'AC', 'Logradoura Imovel X', 564564, 'Complemento Imovel X', 'Bairro Imovel X', '541564654'),
(48, 2707206, 'AL', 'aaaaaaaaaa', 321231, 'aaaaaaaaaaaaaa', 'aaaaaaaa', '321231321');
...
INSERT INTO `imoveis` (`codigo_imovel`, `cpf`, `numero_seq_end`, `codigo_cidade`, `uf`, `descricao`, `qtd_quartos`, `qtd_banheiros`, `qtd_salas`, `piscina`, `vagas_garagem`, `valor`, `habilitado`, `titulo`) VALUES
(25, '333333', 31, 1200013, 'AC', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Loarem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen Lorem Ipsum is simply dummy text of the printing and typesetting industry. Loarem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen Lorem Ipsum is sim', 1, 1, 1, 1, 1, 100, 1, 'Imóvel de ambos@gmail.com'),
(32, '222222', 44, 2900108, 'BA', 'Descrição do Proprietario ', 9, 9, 9, 1, 9, 9, 1, 'Imovel do Proprietario');
...
INSERT INTO `reservas` (`codigo_reserva`, `codigo_imovel`, `cpf`, `data_inicial`, `data_final`) VALUES
(8, 25, '03482023000', '2021-06-22', '2021-07-11'),
(5, 25, '11111', '2021-06-21', '2021-06-21'),
(4, 25, '21142004465', '2021-06-19', '2021-06-19'),
(6, 25, '7789987897', '2021-06-04', '2021-06-04');
...
INSERT INTO `usuarios` (`cpf`, `numero_seq_end`, `codigo_cidade`, `uf`, `nome`, `email`, `telefone`, `foto`, `tipo_usuario`, `senha`) VALUES
('03482023000', 36, 4300034, 'RS', 'Thiago Heron Albano de Ávila2', 'thiagoheronavila@gmail.com2', '539995892761', 'FOTO', 'AMBOS', '81dc9bdb52d04dc20036dbd8313ed055'),
('11111', 25, 3300100, 'RJ', 'Nome Locatario', 'locatario@gmail.com', '111111', 'FOTO', 'LOCATARIO', '81dc9bdb52d04dc20036dbd8313ed055'),
('12312111111', 34, 1200013, 'AC', '22222222222222222222222222222222', 'tkfsepakfdsapo@SFSJF.COM', '11111111111111111111111111111111111111111111111111', 'FOTO', 'LOCATARIO', '6a548fe9bb2b82886df5d3929407a271'),
('21120000000', 45, 4306601, 'RS', 'Guilherme', 'guilhermelocatario@gmail.com', '13213214asdasdasdas', 'FOTO', 'LOCATARIO', '81dc9bdb52d04dc20036dbd8313ed055'),
('21142004465', 45, 4306601, 'RS', 'Guilherme', 'guilhermeambos@gmail.com', '13213214asdasdasdas', 'FOTO', 'AMBOS', '81dc9bdb52d04dc20036dbd8313ed055'),
('222222', 28, 4127809, 'PR', 'Nome Proprietario', 'proprietario@gmail.com', '22222', 'FOTO', 'PROPRIETARIO', '81dc9bdb52d04dc20036dbd8313ed055'),
('333333', 29, 2900306, 'BA', 'Thiago Heron (Ambos)', 'ambos@gmail.com', '53999589276', 'FOTO', 'AMBOS', '81dc9bdb52d04dc20036dbd8313ed055'),
('7789987897', 43, 1200013, 'AC', 'Thiago Heron Albano de Avila', 'thiagoheronavila@gmail.com', 'asdasdasd', 'FOTO', 'AMBOS', '81dc9bdb52d04dc20036dbd8313ed055');
...
--
ALTER TABLE `enderecos`
  MODIFY `numero_seq_end` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Número sequencial do endereço ', AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT de tabela `imoveis`
--
ALTER TABLE `imoveis`
  MODIFY `codigo_imovel` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Código do Imóvel', AUTO_INCREMENT=35;
